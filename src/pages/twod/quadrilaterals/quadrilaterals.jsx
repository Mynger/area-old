    ...
    return (
        <section  className={styles.section}>
            ...
            <article className={styles.reverse}>
                ...
                <Video  src='./src/assets/2d/quadrilaterals/rhombus.mp4'/>
            </article>
